...
export default function Sidebar({ onCompose }) {
	return (
		<div className="p-4 space-y-4">
			<button onClick={onCompose} className="w-full flex items-center gap-2 bg-blue-500 text-white py-2 px-3 rounded-full cursor-pointer"><Plus size={18}/> Redactar </button>
